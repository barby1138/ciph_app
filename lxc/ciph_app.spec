...
install -v -m 0644 build-lxc.sh -D %{buildroot}/tmp/ciph_app/%{version}/build-lxc.sh
...
%post
chmod +x /tmp/ciph_app/%{version}/build-lxc.sh
/tmp/ciph_app/%{version}/build-lxc.sh /tmp/ciph_app/%{version}
