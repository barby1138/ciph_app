...
int32_t ciph_agent_conn_alloc(uint32_t index, uint32_t mode, on_job_complete_cb_t cb)
{
...
int32_t ciph_agent_send(uint32_t index, struct Dpdk_cryptodev_data_vector* jobs, uint32_t size)
{
